...
/////////////////////////////////////////////////
LiftDragPlugin2::LiftDragPlugin2() : cla(1.0), cda(0.01), cma(0.01), rho(1.2041)
{
...
/////////////////////////////////////////////////
void LiftDragPlugin2::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  if (_sdf->HasElement("oswald"))
    this->oswald = _sdf->Get<double>("oswald");

  if (_sdf->HasElement("AR"))
    this->AR = _sdf->Get<double>("AR");

  if (_sdf->HasElement("C_DO"))
    this->C_DO = _sdf->Get<double>("C_DO");

  if (_sdf->HasElement("C_DOL"))
    this->C_DO = _sdf->Get<double>("C_DOL");
...
/////////////////////////////////////////////////
void LiftDragPlugin2::Init()
{
  this->updateConnection = event::Events::ConnectWorldUpdateBegin(
          boost::bind(&LiftDragPlugin2::OnUpdate, this));
}
...
void LiftDragPlugin2::OnUpdate()
{
  ...
  cd=  this->C_DO+this->C_DOL*cl+cl*cl/(this->oswald*this->AR*M_PI); 
  cd=cd*cosSweepAngle2;
