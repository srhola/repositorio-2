...
namespace gazebo
{
  ...
  class GAZEBO_VISIBLE LiftDragPlugin2 : public ModelPlugin
  {
    /// \brief Constructor.
    ...
    ///\ brief oswald efficiency factor 
    protected: double oswald;

    ///\ brief aspect ratio 
    protected: double AR;    

    ///\ brief zero lift drag coefficient 
    protected: double C_DO;

    ///\ brief slope on the point of C_D0 
    protected: double C_DOL; 
