...
class Visualiser:
    ...
    def plot_init(self):
        ...
        self.ax0.set_ylim(0, 15)
        self.ax0.set_title('Rapidez drone1')
        self.ax0.set_xlabel("Tiempo [s]")
        self.ax0.set_ylabel("Rapidez [m/s]")    
        self.ax1.set_xlim(0, 150)
        self.ax1.set_ylim(0, 15)
        self.ax1.set_title('Rapidez drone2')
        self.ax1.set_xlabel("Tiempo [s]")
        self.ax1.set_ylabel("Rapidez [m/s]")    
        self.ax2.set_xlim(0, 150)
        self.ax2.set_ylim(0, 15)
        self.ax2.set_title('Rapidez drone3')
...
#    def odom_callback(self, msg1, msg2,msg3,odom1,odom2,odom3):
    def odom_callback(self,odom1,odom2,odom3):
        ...
        rapidez1=math.sqrt(v1_x**2+v1_y**2)
        rapidez2=math.sqrt(v2_x**2+v2_y**2)
        rapidez3=math.sqrt(v3_x**2+v3_y**2)
        ...
        self.y_data0.append(rapidez1)
        self.y_data1.append(rapidez2)
        self.y_data2.append(rapidez3)
