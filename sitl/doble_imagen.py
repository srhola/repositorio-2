...
#se asigna el nombre pontiac, puede ser cualquier otro nombre 
cv2.namedWindow("pontiac")
cv2.resizeWindow("pontiac",640,240)
cv2.createTrackbar("HUE Min","pontiac",5,179,empty)
cv2.createTrackbar("HUE Max","pontiac",31,179,empty)
cv2.createTrackbar("SAT Min","pontiac",11,255,empty)
cv2.createTrackbar("SAT Max","pontiac",255,255,empty)
cv2.createTrackbar("VALUE Min","pontiac",0,255,empty)
cv2.createTrackbar("VALUE Max","pontiac",255,255,empty)
cv2.createTrackbar("Threshold1","pontiac",107,255,empty)
cv2.createTrackbar("Threshold2","pontiac",113,255,empty)
cv2.createTrackbar("Area","pontiac",150,30000,empty)

'''
cv2.namedWindow("pontiac")
cv2.resizeWindow("pontiac",640,240)
cv2.createTrackbar("HUE Min","pontiac",1,179,empty)
cv2.createTrackbar("HUE Max","pontiac",31,179,empty)
cv2.createTrackbar("SAT Min","pontiac",11,255,empty)
cv2.createTrackbar("SAT Max","pontiac",255,255,empty)
cv2.createTrackbar("VALUE Min","pontiac",0,255,empty)
...
def getcontours(img,imgContour):
	...
	for cnt in contours:
		...
		areaMin=cv2.getTrackbarPos("Area","pontiac")
...
class LineFollower(object):
	...
	def camera_callback(self,data1,data2):
		...
		h_min=cv2.getTrackbarPos("HUE Min","pontiac")
		h_max=cv2.getTrackbarPos("HUE Max","pontiac")
		s_min=cv2.getTrackbarPos("SAT Min","pontiac")
		s_max=cv2.getTrackbarPos("SAT Max","pontiac")
		v_min=cv2.getTrackbarPos("VALUE Min","pontiac")
		v_max=cv2.getTrackbarPos("VALUE Max","pontiac")
		#print(h_min)
		...
		Threshold1=cv2.getTrackbarPos("Threshold1","pontiac")
		Threshold2=cv2.getTrackbarPos("Threshold2","pontiac")
